...
from entities.root_container.field_container.segment.arc_node_entity import ArcNodeEntity
if TYPE_CHECKING:
...
"""
View in MVC model for drawing arcs. References segment model and arc state model
"""
