...
from entities.root_container.panel_container.command_block.highlight_path_entity import HighlightPathEntity
from entities.root_container.panel_container.command_block.wait_entity import WaitEntity
if TYPE_CHECKING:
...
from entities.root_container.panel_container.command_block.icon_entity import CommandBlockIcon
from entities.root_container.panel_container.command_block.trash_button_entity import TrashEntity
from entities.root_container.panel_container.command_block.function_name_entity import FunctionNameEntity
