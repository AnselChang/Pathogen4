...
class CommandDefinition:
    ...
    def __init__(self, type: CommandType, name: str, color: tuple, elements: list[ElementDefinition] = [], templateText: str = "// [default text]", isCode: bool = False, nonblockingEnabled: bool = False):
